...
class LoginRespose :
 ...
 public:
  ...
  inline LoginRespose* New() const final {
    return CreateMaybeMessage<LoginRespose>(nullptr);
  }
...
// bool success = 3;
inline void LoginRespose::clear_success() {
  success_ = false;
}
inline bool LoginRespose::_internal_success() const {
  return success_;
}
inline bool LoginRespose::success() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRespose.success)
  return _internal_success();
}
inline void LoginRespose::_internal_set_success(bool value) {
  
  success_ = value;
}
inline void LoginRespose::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginRespose.success)
}
