...
class GetFriendListResposeDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListRespose> _instance;
...
static void InitDefaultsscc_info_GetFriendListRespose_friend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListRespose_default_instance_;
    new (ptr) ::fixbug::GetFriendListRespose();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListRespose::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFriendListRespose_friend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetFriendListRespose_friend_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespose, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespose, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespose, friends_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::fixbug::ResultCode)},
  { 7, -1, sizeof(::fixbug::GetFriendListRequest)},
  { 13, -1, sizeof(::fixbug::GetFriendListRespose)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListRespose_default_instance_),
};
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "iceRpc\022L\n\016GetFriendsList\022\034.fixbug.GetFri"
  "endListRequest\032\034.fixbug.GetFriendListRes"
  "poseB\003\200\001\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_friend_2eproto_sccs[3] = {
  ...
  &scc_info_GetFriendListRespose_friend_2eproto.base,
  &scc_info_ResultCode_friend_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_friend_2eproto = {
  &descriptor_table_friend_2eproto_initialized, descriptor_table_protodef_friend_2eproto, "friend.proto", 297,
...
void GetFriendListRespose::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListRespose_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListRespose::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListRespose* msg);
};

const ::fixbug::ResultCode&
GetFriendListRespose::_Internal::result(const GetFriendListRespose* msg) {
  return *msg->result_;
}
GetFriendListRespose::GetFriendListRespose()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFriendListRespose)
}
GetFriendListRespose::GetFriendListRespose(const GetFriendListRespose& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListRespose)
}

void GetFriendListRespose::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListRespose_friend_2eproto.base);
  result_ = nullptr;
}

GetFriendListRespose::~GetFriendListRespose() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListRespose)
  SharedDtor();
}

void GetFriendListRespose::SharedDtor() {
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListRespose::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListRespose& GetFriendListRespose::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListRespose_friend_2eproto.base);
  return *internal_default_instance();
}


void GetFriendListRespose::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListRespose)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListRespose::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListRespose::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListRespose)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListRespose)
  return target;
}

size_t GetFriendListRespose::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListRespose)
  size_t total_size = 0;
...
void GetFriendListRespose::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListRespose)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListRespose* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListRespose>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListRespose)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListRespose)
    MergeFrom(*source);
  }
}

void GetFriendListRespose::MergeFrom(const GetFriendListRespose& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListRespose)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListRespose::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListRespose)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendListRespose::CopyFrom(const GetFriendListRespose& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListRespose)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListRespose::IsInitialized() const {
  return true;
}

void GetFriendListRespose::InternalSwap(GetFriendListRespose* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListRespose::GetMetadata() const {
  return GetMetadataStatic();
}
    ...
    case 0:
      GetFriendsList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListRespose*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fixbug::GetFriendListRespose::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListRespose* Arena::CreateMaybeMessage< ::fixbug::GetFriendListRespose >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFriendListRespose >(arena);
}
