...
class RegisterRespose :
 ...
 public:
  ...
  inline RegisterRespose* New() const final {
    return CreateMaybeMessage<RegisterRespose>(nullptr);
  }

  RegisterRespose* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
