...
class GetFriendListRespose;
class GetFriendListResposeDefaultTypeInternal;
extern GetFriendListResposeDefaultTypeInternal _GetFriendListRespose_default_instance_;
class ResultCode;
...
template<> ::fixbug::GetFriendListRespose* Arena::CreateMaybeMessage<::fixbug::GetFriendListRespose>(Arena*);
...
class GetFriendListRespose :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListRespose) */ {
 public:
  GetFriendListRespose();
  virtual ~GetFriendListRespose();

  GetFriendListRespose(const GetFriendListRespose& from);
  GetFriendListRespose(GetFriendListRespose&& from) noexcept
    : GetFriendListRespose() {
    *this = ::std::move(from);
  }

  inline GetFriendListRespose& operator=(const GetFriendListRespose& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListRespose& operator=(GetFriendListRespose&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListRespose& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListRespose* internal_default_instance() {
    return reinterpret_cast<const GetFriendListRespose*>(
               &_GetFriendListRespose_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(GetFriendListRespose& a, GetFriendListRespose& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListRespose* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriendListRespose* New() const final {
    return CreateMaybeMessage<GetFriendListRespose>(nullptr);
  }

  GetFriendListRespose* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListRespose>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListRespose& from);
  void MergeFrom(const GetFriendListRespose& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListRespose* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListRespose";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListRespose)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListRespose::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListRespose::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListRespose::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListRespose::_internal_result() const {
...
inline const ::fixbug::ResultCode& GetFriendListRespose::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRespose.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFriendListRespose::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListRespose.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListRespose::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListRespose::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListRespose.result)
  return _internal_mutable_result();
}
inline void GetFriendListRespose::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListRespose.result)
}

// repeated bytes friends = 2;
inline int GetFriendListRespose::_internal_friends_size() const {
  return friends_.size();
}
inline int GetFriendListRespose::friends_size() const {
  return _internal_friends_size();
}
inline void GetFriendListRespose::clear_friends() {
  friends_.Clear();
}
inline std::string* GetFriendListRespose::add_friends() {
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendListRespose.friends)
  return _internal_add_friends();
}
inline const std::string& GetFriendListRespose::_internal_friends(int index) const {
  return friends_.Get(index);
}
inline const std::string& GetFriendListRespose::friends(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRespose.friends)
  return _internal_friends(index);
}
inline std::string* GetFriendListRespose::mutable_friends(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListRespose.friends)
  return friends_.Mutable(index);
}
inline void GetFriendListRespose::set_friends(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRespose.friends)
  friends_.Mutable(index)->assign(value);
}
inline void GetFriendListRespose::set_friends(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRespose.friends)
  friends_.Mutable(index)->assign(std::move(value));
}
inline void GetFriendListRespose::set_friends(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListRespose.friends)
}
inline void GetFriendListRespose::set_friends(int index, const void* value, size_t size) {
  friends_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListRespose.friends)
}
inline std::string* GetFriendListRespose::_internal_add_friends() {
  return friends_.Add();
}
inline void GetFriendListRespose::add_friends(const std::string& value) {
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListRespose.friends)
}
inline void GetFriendListRespose::add_friends(std::string&& value) {
  friends_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListRespose.friends)
}
inline void GetFriendListRespose::add_friends(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendListRespose.friends)
}
inline void GetFriendListRespose::add_friends(const void* value, size_t size) {
  friends_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendListRespose.friends)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetFriendListRespose::friends() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListRespose.friends)
  return friends_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetFriendListRespose::mutable_friends() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListRespose.friends)
  return &friends_;
}
